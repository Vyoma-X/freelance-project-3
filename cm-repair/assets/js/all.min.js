...
// Category filtering
document.querySelectorAll('.product-filter-buttons-2 .btn').forEach(button => {
  button.addEventListener('click', () => {
      const filter = button.getAttribute('data-filter');
      
      // Update active button
      document.querySelectorAll('.product-filter-buttons-2 .btn').forEach(btn => {
      ...
      slides.forEach(slide => {
          if (filter === 'all' || slide.getAttribute('data-category').includes(filter)) {
              slide.style.display = '';
          } else {
